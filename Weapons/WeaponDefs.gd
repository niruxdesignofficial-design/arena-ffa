...
const DEFS: Array[Dictionary] = [
	...
	{
		"name": "MAC-10", "starter": true, "sfx": "smg", "model": "res://Assets/Guns/mac10.glb", "uses_ammo": true,
	...
	{
		"name": "Shotgun", "starter": true, "sfx": "shotgun", "model": "res://Assets/Guns/shotgun.glb", "uses_ammo": true,
	...
	{
		"name": "AK-47", "starter": true, "sfx": "rifle", "model": "res://Assets/Guns/ak47.glb", "uses_ammo": true,
		"damage": 22, "cooldown": 0.12, "range": 150.0,
		"mag": 30, "reserve": 90, "reload": 2.2, "auto": true, "pellets": 0,
		"crosshair": "res://UI/Crosshairs/Data/plus.tres",
	},
	{
		"name": "AWP", "starter": true, "sfx": "sniper", "model": "res://Assets/Guns/awp.glb", "uses_ammo": true,
